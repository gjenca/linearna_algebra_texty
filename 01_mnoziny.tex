...
\begin{definicia}[Množina]\label{def:mnozina}
...
\begin{definicia}[Kartézsky súčin]
Nech $A, B$ sú množiny.
...
Objekt $b$ s vlastnosťou $b\in\emptyset$ však neexistuje,
...
neexistujúce slovenské slovo ,,tica'' ak budem chcieť vyjadriť, že niečo je usporiadaná dvojica,
...
\end{itemize}
Máme napríklad $(1, \sqrt{2}, -\pi, 17) \in \mathbb{R}^4$.
