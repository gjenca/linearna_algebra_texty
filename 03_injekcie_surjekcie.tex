...
\[
\text{Miško}\neq\text{Anka}\qquad j(\text{Miško})=j(\text{Anka})
\]
...
f_2\colon\mathbb R\to \mathbb \langle 1,\infty) &\qquad f_2(x)=x^2+1
\end{align*}
...
Nech $A,B$ sú množiny. Zobrazeniu $f\colon A\to B$ hovoríme,
\emph{bijekcia/bijektívne} ak je injektívne a zároveň surjektívne.
$f(a)=b$.
\end{definicia}
