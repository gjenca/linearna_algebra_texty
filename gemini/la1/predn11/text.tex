...
\begin{definicia} \label{def:suradniceVBaze}
...
\begin{enumerate}[a)]
    ...
    \textbf{NIE}, pretože a obsahuje nulový vektor a teda je lineárne závislá.
    \item Je $((1,2,3), (3,2,1))$ báza $\R^3$? \\
    \textbf{NIE}, lebo má 2 prvky a $\dim(\R^3)=3$.
    \item Je $((1,1), (4,4), (3,2))$ lineárne závislá v $\R^2$? \\
    ...
    \ref{veta:porovnavanieTic} takto: vieme, že $\dim(\R^2)=2$ a teda teda existuje
    ...
    \textbf{NIE.} Podľa pretože $\dim(\R^2[x])=3$ a podľa 
...
dostaneme sústavu lineárnych rovních, ktorej jediné riešenie $a_1=a_2=a+3=0$.
