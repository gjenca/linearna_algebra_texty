...
\begin{enumerate}
    ...
    \item $\forall a \in K, a \neq 0, \exists b \in K: a \cdot b = 1$ (existencia inverzného prvku) \footnote{Takéto $b$
    je pre každé $a\in K$ jediné a značí sa $a^{-1}$.}
...
$$ a + bi $$
kde $a, b \in \R$. Toto sa nazýva \textbf{algebraický tvar komplexného čísla}.
